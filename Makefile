...
.PHONY: doc a2560x test_w65c02s test_65c816 c256u

all: a2560x test_w65c02s test_65c816 c256u
...
help:
	...
	@echo "make c256u        - build a c256u(+) emulator"
...
c256u:
	odin build cmd/c256u -debug $(build_flags)
