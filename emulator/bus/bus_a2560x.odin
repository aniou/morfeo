...
a2560x_read :: proc(bus: ^Bus, size: emu.Bitsize, addr: u32) -> (val: u32) {
    ...
    case 0xFE_C0_0200 ..= 0xFE_C0_022F:  val = bus.timer0->read(size, 0xFE_C0_0200, addr)
    ...
    case 0xFE_C4_8000 ..= 0xFE_C4_8FFF:  val =   bus.gpu0->read(size, 0xFE_C4_8000, addr, .FONT_BANK0)
    case 0xFE_C6_0000 ..= 0xFE_C6_3FFF:  val =   bus.gpu0->read(size, 0xFE_C6_0000, addr, .TEXT)
    case 0xFE_C6_8000 ..= 0xFE_C6_BFFF:  val =   bus.gpu0->read(size, 0xFE_C6_8000, addr, .TEXT_COLOR)
    case 0xFE_C6_C400 ..= 0xFE_C6_C43F:  val =   bus.gpu0->read(size, 0xFE_C6_C400, addr, .TEXT_FG_LUT)
    case 0xFE_C6_C440 ..= 0xFE_C6_C47F:  val =   bus.gpu0->read(size, 0xFE_C6_C440, addr, .TEXT_BG_LUT)

    case 0xFE_C8_0000 ..= 0xFE_C8_003C:  val =   bus.gpu1->read(size, 0xFE_C8_0000, addr, .MAIN_B)
    case 0xFE_C8_0100 ..= 0xFE_C8_0107:  val =   bus.gpu1->read(size, 0xFE_C8_0000, addr, .MAIN_B)
    case 0xFE_C8_2000 ..= 0xFE_C8_3FFF:  val =   bus.gpu1->read(size, 0xFE_C8_2000, addr, .LUT)
    case 0xFE_C8_8000 ..= 0xFE_C8_8FFF:  val =   bus.gpu1->read(size, 0xFE_C8_8000, addr, .FONT_BANK0)
    case 0xFE_CA_0000 ..= 0xFE_CA_3FFF:  val =   bus.gpu1->read(size, 0xFE_CA_0000, addr, .TEXT)
    case 0xFE_CA_8000 ..= 0xFE_CA_BFFF:  val =   bus.gpu1->read(size, 0xFE_CA_8000, addr, .TEXT_COLOR)
    case 0xFE_CA_C400 ..= 0xFE_CA_C43F:  val =   bus.gpu1->read(size, 0xFE_CA_C400, addr, .TEXT_FG_LUT)
    case 0xFE_CA_C440 ..= 0xFE_CA_C47F:  val =   bus.gpu1->read(size, 0xFE_CA_C440, addr, .TEXT_BG_LUT)
...
a2560x_write :: proc(bus: ^Bus, size: emu.Bitsize, addr, val: u32) {
    ...
    case 0xFE_C0_0200 ..= 0xFE_C0_022F:  bus.timer0->write(size, 0xFE_C0_0200, addr, val)
    ...
    case 0xFE_C4_8000 ..= 0xFE_C4_8FFF:    bus.gpu0->write(size, 0xFE_C4_8000, addr, val, .FONT_BANK0)
    case 0xFE_C6_0000 ..= 0xFE_C6_3FFF:    bus.gpu0->write(size, 0xFE_C6_0000, addr, val, .TEXT)
    case 0xFE_C6_8000 ..= 0xFE_C6_BFFF:    bus.gpu0->write(size, 0xFE_C6_8000, addr, val, .TEXT_COLOR)
    case 0xFE_C6_C400 ..= 0xFE_C6_C43F:    bus.gpu0->write(size, 0xFE_C6_C400, addr, val, .TEXT_FG_LUT)
    case 0xFE_C6_C440 ..= 0xFE_C6_C47F:    bus.gpu0->write(size, 0xFE_C6_C440, addr, val, .TEXT_BG_LUT)

    case 0xFE_C8_0000 ..= 0xFE_C8_003C:    bus.gpu1->write(size, 0xFE_C8_0000, addr, val, .MAIN_B)
    case 0xFE_C8_0100 ..= 0xFE_C8_0107:    bus.gpu1->write(size, 0xFE_C8_0000, addr, val, .MAIN_B)
    case 0xFE_C8_2000 ..= 0xFE_C8_3FFF:    bus.gpu1->write(size, 0xFE_C8_2000, addr, val, .LUT)
    case 0xFE_C8_8000 ..= 0xFE_C8_8FFF:    bus.gpu1->write(size, 0xFE_C8_8000, addr, val, .FONT_BANK0)
    case 0xFE_CA_0000 ..= 0xFE_CA_3FFF:    bus.gpu1->write(size, 0xFE_CA_0000, addr, val, .TEXT)
    case 0xFE_CA_8000 ..= 0xFE_CA_BFFF:    bus.gpu1->write(size, 0xFE_CA_8000, addr, val, .TEXT_COLOR)
    case 0xFE_CA_C400 ..= 0xFE_CA_C43F:    bus.gpu1->write(size, 0xFE_CA_C400, addr, val, .TEXT_FG_LUT)
    case 0xFE_CA_C440 ..= 0xFE_CA_C47F:    bus.gpu1->write(size, 0xFE_CA_C440, addr, val, .TEXT_BG_LUT)
